     ...
     $('#EditArticle').submit(function(e) {
         ...
         $.ajax({
             ...
             statusCode: {
                 200: function() {
                     $("#success").show(500);
                     setTimeout(function() { $("#success").hide(500); }, 6000);
                 },
                 400: function() {
                 ...
                 503: function() {
                     $('#invalidM').html(" Doslo je do greske prilikom izmene clanka, pokusajte ponovo!");
                     $("#invalid").show(500);
                     setTimeout(function() { $("#invalid").hide(500); }, 2500);
                 },

                 403: function() {
                     $('#invalidM').html(" Ne mozete da menjate clanak koji Vi niste objavili!");
                     $("#invalid").show(500);
                     setTimeout(function() { $("#invalid").hide(500); }, 2500);
                 },
